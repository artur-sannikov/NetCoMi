...
![](reference/figures/soilrep_networks_curved.png)
...
- Cumulative Sum Scaling (CSS) ([`cumNormMat`](https://netcomi.de/) from
  `metagenomeSeq` package)
- Common Sum Scaling (COM) (own implementation)
- Rarefying ([`rrarefy`](https://netcomi.de/) from `vegan` package)
- Variance Stabilizing Transformation (VST)
  ([`varianceStabilizingTransformation`](https://netcomi.de/) from
  `DESeq2` package)
...
Boulesteix, and Martin Depner. 2020. “NetCoMi: network construction and
comparison for microbiome data in R.” *Briefings in Bioinformatics* 22
(4): bbaa290. <https://doi.org/10.1093/bib/bbaa290>.
